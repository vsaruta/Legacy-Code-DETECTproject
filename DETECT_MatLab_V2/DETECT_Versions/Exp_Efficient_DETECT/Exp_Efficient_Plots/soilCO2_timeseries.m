...
for s=1:3,
    ...
    if (s<=2)
        %Read in the temperature data for plot:
         load([pwd '/DETECT_Versions/Exp_Efficient_DETECT/Exp_Efficient_Inputs/PHACEdata_6hourly'  '.mat'])
...
%         load(['../Outputs/output_6hourly' num2str(ant) '.mat'])
        load([pwd '/DETECT_Versions/Exp_Efficient_DETECT/Exp_Efficient_Outputs/output_6hourly'  '.mat'])
        cctype=out.CO2type;
