...
Rall = Efficient_SourceTerm(params,params_lag,Xrel,SWC,SoilT,SWCant_Rm,SWCant_Rr,SoilTant,Gness);
R = [zeros(Nt,1) Rall.R];
...
info.SWCant_Rm_my = Rall.SWCant_Rm_my;
info.SWCant_Rr_my = Rall.SWCant_Rr_my;
